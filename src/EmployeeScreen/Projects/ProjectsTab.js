...
function ProjectsTab() {
  ...
  return (
    <PageComponent
      ...
      listOfButtons={
        tab === "open" || tab === "assignedTasks"
          ? [
              {
                buttonName: "Add New Task",
                onClickFunction: function () {
                  navigate(`/taskEmployee/add/form/${id}`);
                },
              },
              {
                buttonName:
                  tab === "open" ? "Assigned Tasks" : "Project Details",
                onClickFunction: function () {
                  navigate(
                    tab === "open"
                      ? `/projectsEmployee/assignedTasks/${id}`
                      : `/projectsEmployee/open/${id}`,
                  );
                },
              },
              {
